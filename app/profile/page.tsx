    ...
    <div className="mobile-shell flex flex-col bg-[#F5F5F5]">
      ...
      <div className="flex-1 overflow-y-auto pb-20">
        ...
        <div className="relative bg-white mb-3">
          ...
          {/* Edit button */}
          <button className="absolute bottom-3 right-4 w-9 h-9 bg-brand rounded-full flex items-center justify-center shadow-lg">
            <Edit3 size={15} className="text-white" />
          </button>

          {/* Name & badge */}
          <div className="px-5 pt-3 pb-4">
            <h1 className="text-2xl font-black text-gray-900 mb-1.5">Hero Alam</h1>
            ...
            <p className="text-sm text-gray-500 leading-relaxed mt-3">
              Senior CS Student at United International University. Eco-conscious commuter. I love early morning rides and discussing open-source tech.
            </p>
            {/* Rating */}
        ...
        <section className="mx-4 mb-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="rs-card p-4">
              ...
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Rides Given</p>
            </div>
            <div className="rs-card p-4">
              <div className="flex items-center gap-2 mb-1">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-brand"><path d="M3 12h18M3 6h18M3 18h18"/></svg>
              </div>
              <p className="text-2xl font-black text-gray-900">1.2k</p>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">KM Shared</p>
            </div>
            <div className="rounded-2xl bg-brand p-4">
              ...
              <p className="text-[10px] font-black text-red-200 uppercase tracking-widest">CO2 Saved</p>
            </div>
            <div className="rs-card p-4">
              <div className="flex items-center gap-2 mb-1">
        ...
        <section className="mx-4 mb-3">
          <div className="rs-card p-4">
            <p className="text-[11px] font-black text-brand uppercase tracking-widest mb-3">Personal Information</p>
            {[
              { label: "University Email", value: "j.miller@wcu.edu.ac" },
              { label: "Major & Year", value: "Computer Science, Year 4" },
              { label: "Preferred Music", value: "Indie, Lo-fi, Tech Podcasts" },
            ].map((item) => (
              <div key={item.label} className="flex items-start justify-between py-3 border-b border-gray-50 last:border-0">
                ...
                <button className="text-brand text-xs font-bold mt-0.5">Edit</button>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mx-4 mb-4">
          <div className="rs-card p-4">
            <div className="flex items-center justify-between mb-3">
              <p className="text-[11px] font-black text-brand uppercase tracking-widest">Vehicle Details</p>
              <span className="text-[10px] font-bold text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full">Primary Car</span>
            </div>
            ...
            <div className="inline-block border border-gray-200 rounded-full px-3 py-1">
              <span className="text-xs font-black text-gray-700 tracking-widest">VELOCITY-24</span>
            </div>
          </div>
        </section>
      </div>
