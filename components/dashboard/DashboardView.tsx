      ...
      <div className="flex-1 overflow-y-auto pb-20">
        ...
        <section className="px-4 py-4 bg-white mb-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Link
              href="/rides/post"
              className="flex flex-col items-center justify-center gap-2 rounded-2xl bg-brand py-6 text-white transition hover:bg-brand-dark"
            >
              <Plus size={24} strokeWidth={2.5} />
              <span className="text-[11px] font-bold tracking-widest">OFFER RIDE</span>
            </Link>
            {/* Find Ride - light gray */}
            <Link
              href="/rides/search"
              className="flex flex-col items-center justify-center gap-2 rounded-2xl bg-gray-100 py-6 text-gray-600 transition hover:bg-gray-200"
            >
              <Search size={22} strokeWidth={2} />
              <span className="text-[11px] font-bold tracking-widest text-gray-600">FIND RIDE</span>
            </Link>
            {/* History - light gray */}
            <div className="flex flex-col items-center justify-center gap-2 rounded-2xl bg-gray-100 py-6 text-gray-500 cursor-pointer hover:bg-gray-200 transition">
              <History size={22} strokeWidth={2} />
              <span className="text-[11px] font-bold tracking-widest">HISTORY</span>
            </div>
            {/* Stats - salmon/coral */}
            <div className="flex flex-col items-center justify-center gap-2 rounded-2xl py-6 cursor-pointer transition" style={{ backgroundColor: "#F28B82" }}>
              <BarChart2 size={22} strokeWidth={2} className="text-white" />
              <span className="text-[11px] font-bold tracking-widest text-white">STATS</span>
            </div>
          </div>
        </section>
        ...
        <section className="mx-4 mb-3">
          <div className="rs-card px-4 py-3 flex items-center gap-3 overflow-hidden relative">
            <div>
              <span className="inline-block text-[10px] font-black bg-gray-800 text-white px-2 py-0.5 rounded-full mb-1">PRO TIP</span>
        ...
        <section className="px-4 mb-3">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-lg font-black text-gray-900">My Upcoming Rides</h2>
          ...
          <div className="rs-card p-4 mb-3 border-l-4 border-brand">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="text-[10px] font-black text-brand uppercase tracking-wider">Active Now</span>
                  <p className="text-base font-black text-gray-900 leading-tight">Morning Lab<br />Shuttle</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-xl font-black text-gray-900">08:45</p>
                <p className="text-[10px] text-gray-400 uppercase tracking-wider">Arrival<br />Time</p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                <div className="flex-1">
                  <div className="mb-3">
                    ...
                    <p className="text-sm font-bold text-gray-900">North Campus Library</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Destination</p>
                    <p className="text-sm font-bold text-gray-900">Engineering Block B</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Verified Graduate Student</p>
                </div>
              </div>
          ...
          <div className="rs-card p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-gray-700">Tomorrow, 14:00</span>
              </div>
            ...
            <div className="flex items-center gap-4 mb-3">
              <div>
                <p className="text-[10px] text-gray-400 uppercase font-bold tracking-widest mb-0.5">From</p>
                <p className="text-sm font-black text-gray-900">South Dorms</p>
              </div>
              <div className="flex-1 h-px bg-gray-200" />
              <div>
                <p className="text-[10px] text-gray-400 uppercase font-bold tracking-widest mb-0.5">To</p>
                <p className="text-sm font-black text-gray-900">Sports Arena</p>
              </div>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="flex -space-x-2">
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=40&auto=format&fit=crop" alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" />
                <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=40&auto=format&fit=crop" alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" />
                <div className="w-7 h-7 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-[9px] font-bold text-gray-600">+1</div>
              </div>
              <span className="text-xs text-gray-500 font-medium ml-1">3 Passengers Total</span>
            </div>
          </div>
        </section>
      </div>
